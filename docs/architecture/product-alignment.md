...
| Developer platform                | Broad foundation       | Public REST API, internal GraphQL, interactive OpenAPI explorer, Python/JavaScript/Java/.NET SDKs, Python CLI, examples, and developer portal are present. Contract completeness and release/version policy need continued work.                                                                                |
