...
OBJECT_STORAGE_ENDPOINT_URL =config("R2_ENDPOINT_URL", default=os.getenv("OBJECT_STORAGE_ENDPOINT_URL", ""))
OBJECT_STORAGE_ACCESS_KEY_ID = config("R2_ACCESS_KEY_ID")
OBJECT_STORAGE_SECRET_ACCESS_KEY = config("R2_SECRET_ACCESS_KEY")
OBJECT_STORAGE_ACCOUNT_ID = config("R2_ACCOUNT_ID", default=os.getenv("OBJECT_STORAGE_ACCOUNT_ID", ""))
