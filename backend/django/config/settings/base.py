...
AI_SERVICE_TIMEOUT_SECONDS = int(os.getenv("AI_SERVICE_TIMEOUT_SECONDS", "120"))
...
WEBHOOK_SECRET_ROTATION_OVERLAP_SECONDS = int(
    os.getenv("WEBHOOK_SECRET_ROTATION_OVERLAP_SECONDS", "86400")
)
