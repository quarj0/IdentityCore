...
export function LiveSubjectsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeading
        title="Subjects"
        description="View people and entities that have gone through verification workflows."
      />
      {error ? (
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Subjects will appear after verification requests are created."
        />
      ) : (
