...
export function LiveWebhooksPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeading
        title="Webhooks"
        description="Send verification lifecycle events to your application."
      />
      {message ? (
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={async () => {
              ...
              setMessage("Webhook signing secret copied.");
            }}
          >
      ...
      {pendingApproval && items.length >= 1 ? (
        <Card className="border-amber-200 bg-amber-50">
          <CardContent className="p-5 text-sm text-amber-900">
            <p className="font-semibold">Test-webhook limit reached</p>
            <p className="mt-1">
              Pending workspaces can configure one disabled sandbox webhook and
              send test events only. Live delivery unlocks after approval.
            </p>
          </CardContent>
        </Card>
      ) : (
            ...
            <form onSubmit={create} className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <Input
                  ...
                  type="url"
                  required
                  placeholder="https://example.com/webhooks/identitycore"
                />
              </div>
              <div>
