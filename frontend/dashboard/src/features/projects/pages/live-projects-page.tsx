...
export function LiveProjectsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeading
        title="Projects"
        description="Isolated sandbox and production environments."
      />
      {error ? (
      ...
      {limited ? (
        <Card className="border-amber-200 bg-amber-50">
          <CardContent className="p-5 text-sm text-amber-900">
            <p className="font-semibold">Sandbox project ready</p>
            <p className="mt-1">
              Pending workspaces are limited to this project. Production
              projects unlock after approval.
            </p>
          </CardContent>
        </Card>
      ) : (
