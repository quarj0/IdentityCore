      ...
      <header className="border-b border-border/80 bg-card/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-info text-info-foreground shadow-sm shadow-info/20">
            ...
            <div className="mt-4 flex items-center gap-3">
              {organizationLogoUrl ? (
                ...
                <img
                  ...
                  alt=""
                  className="h-11 w-11 rounded-2xl border border-border bg-card object-contain p-1.5"
                />
              ) : (
