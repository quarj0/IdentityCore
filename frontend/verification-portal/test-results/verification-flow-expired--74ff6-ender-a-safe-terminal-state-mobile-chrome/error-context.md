...
Locator: getByRole('heading', { name: 'This session has expired' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'This session has expired' })
...
- link "Skip to content":
  - /url: "#main-content"
- main:
  - heading "Opening your secure session" [level=1]
  - paragraph: Validating your one-time session credential…
```
